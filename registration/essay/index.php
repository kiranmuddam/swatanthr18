...
<body>
    ...
    <div class="jumbotron  text-center ">
        <br><a href="#" >&nbsp;<span class="font-big color-red"> <?php echo $title;?></span></a><br><br><b>Topic : </b> - <big><b><u>What does Independence mean to you?</u></b></big><br><br><b>
    </div>
    <!--End jumbotron-->
    <div class="container">
...
//teams
     echo "<center>";
	$kt=mysql_query("SELECT * FROM users WHERE eid='essay' and (ids LIKE 'N16%' || ids LIKE 'N17%' || ids LIKE 'S16%' || ids LIKE 'N18%' || ids LIKE 'S18%' || ids LIKE 'S17%')") or die(mysql_error());
