...
<body>
    ...
    <div class="jumbotron  text-center ">
        ...
        SDCAC would like to organize Swatanthr 2k'18, SDCAC on the eve of Independence
...
<b><u>Rules:</u></b><br>
Open to all.<br>
Group event (group is strictly confined to 2 members)<br>
...
//teams
     echo "<center>";
	$kt=mysql_query("SELECT * FROM users WHERE eid='quiz' and (ids LIKE 'N16%' || ids LIKE 'N17%' || ids LIKE 'S16%' || ids LIKE 'N18%' || ids LIKE 'S18%' || ids LIKE 'S17%')") or die(mysql_error());
